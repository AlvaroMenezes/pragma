...
public class User {
    ...
    public String toString() {
        return "ClassUser [profile_url = " + profile_url + ", profile_image = " + profile_image + ", profile_deeplink = " + profile_deeplink + ", name = " + name + ", foodie_level = " + foodie_level + ", foodie_color = " + foodie_color + ", zomato_handle = " + zomato_handle + ", foodie_level_num = " + foodie_level_num + "]";
    }
}
